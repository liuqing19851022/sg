...
{
    public static class StringToPinYinExtention
    {
        #region 数组信息
        ...
        private static string[] otherChinese = new string[]
        {
            ...
            ,"黟","黢","黩","黧","黥","黪","黯","鼢","鼬","鼯","鼹","鼷","鼽","鼾","齄","坨"            
        };

        //,"怡","枸","杞","琪","枞","柚","煸","苕","芙","芸","醪","婕","莴","樽","璇","沐","蕲","胱","靓","炖","糌","粑","喱","煲","藿","鲫","枼","腩","炝"
        ...
        private static string[] otherPinYin = new string[]
           {
               "Chu","Ji","Wu","Gai","Nian","Sa","Pi","Gen","Cheng","Ge","Nao","E","Shu","Yu","Pie","Bi",
                ...
                "Xia","Yi","Qu","Du","Li","Qing","Can","An","Fen","You","Wu","Yan","Xi","Qiu","Han","Zha","Tuo"                
           };
        //"Yi","Gou","Qi","Qi","Zong","You","Bian","Shao","Fu","Yun","Lao","Jie","Wo","Zun","Xuan","Mu","Qi","Guang","Liang","Dun","Zan","Ba","Li","Bao","Huo","Ji","Ye","Nan","Qiang"
        #endregion 二级汉字
        #region 变量定义
        ...
        /// <param name="ch"></param>        
        /// <returns></returns>        
        public static String GetFirst(this Char ch)
        {
            var rs = Get(ch);
